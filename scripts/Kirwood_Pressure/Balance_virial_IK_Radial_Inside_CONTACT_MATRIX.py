...
class InitializeSimulation:
    ...
    def calculate_pressure(self):
        ...
        pressures = [] 
        neighbor_lists = []
        output_file = f"atom_positions_and_neighbors_old_{self.segment}_data.txt"
        ...
        with open(output_file, "a") as f:
            ...
            for cpt, array in enumerate(self.matrix[:-1]):
                ...
                list = [ele for ele in list if ele > cpt and  ele != self.indices[cpt]] # each neighbor is considered only once due to ele > cpt !
                #print("Num INT:\n",len(list))
                ...
                f.write(f"current_atom_position: {self.universe[self.indices[cpt]].position}\n")
                ...
                #print("neighbors:\n",list)
                f.write(f"neighbor_positions of atom {self.indices[cpt]}: {neighbor_positions}\n")
