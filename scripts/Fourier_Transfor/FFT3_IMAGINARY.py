...
for index, row in df.iterrows():
    ...
    #print("fft_result2:\n",fft_result)
    real_part_sorted = fft_result.imag
...
fig.suptitle('Imaginary Part Gaussian Distributions', fontsize=16)
